...
import com.example.server.pharmacist.entity.Gender;
import com.example.server.pharmacist.repository.GenderRepository;
...
@RestController public class GenderController {

    @Autowired private final GenderRepository genderRepository;
